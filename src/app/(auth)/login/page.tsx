                    ...
                    <div className="relative z-10 flex flex-col justify-center px-12 xl:px-16">
                        ...
                        >
                            ...
                            <p className="text-xl text-slate-600 dark:text-slate-300 leading-relaxed">
                                Khám phá tư tưởng Hồ Chí Minh qua những cuộc tranh luận sôi nổi,
                                tác phẩm bất hủ và bài học quý báu.
                            </p>
                        </motion.div>
                            ...
                            <div className="flex items-center justify-center space-x-3 mb-4">
                                <div className="relative">
                                    <motion.div
                                        ...
                                        className="absolute inset-0 bg-gradient-to-r from-red-400 to-yellow-400 rounded-full blur opacity-30"
                                    />
                                    <div className="relative w-12 h-12 bg-gradient-to-r from-red-500 to-yellow-500 rounded-full flex items-center justify-center">
                                        <span className="text-lg font-bold text-white">HCM</span>
                                    </div>
                                </div>
                                <div>
